...
data = readmatrix('4.7k_ohmECG.CSV'); %imports data from Excel into a matrix
...
%Generate frequency magnitude and phase spectra using FFT
...
subplot(2,1,2)
phasez(b) %phase response
title('Phase Response - 470 Ohm Resistor')